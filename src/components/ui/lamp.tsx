...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-[40rem] flex-col items-center justify-center overflow-visible bg-transparent w-full z-0",
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0">
        ...
        <div className="absolute inset-auto z-50 h-36 w-[48rem] -translate-y-1/2 rounded-full bg-primary opacity-50 blur-3xl"></div>
        <motion.div
          initial={{ width: "12rem" }}
