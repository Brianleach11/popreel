...
import { ArrowRight, Video as VideoIcon, Sparkles, Users } from "lucide-react";
import { Feed } from "@/components/feed/feed";
import { Video } from "@/components/feed/feed";
  ...
  return (
    <div className="flex flex-col min-h-screen bg-black text-white">
      ...
      <section className="py-16 border-t border-gray-800">
        ...
        <div className="grid gap-8 pr-8 pl-8 sm:grid-cols-1 lg:grid-cols-3">
          ...
          <div className="flex flex-col space-y-2 p-6 rounded-lg border border-gray-800">
            <VideoIcon className="h-8 w-8 mb-2 text-primary" />
